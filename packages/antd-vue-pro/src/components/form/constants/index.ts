...
export const INIT_COMPONENT_PROPS_MAP = new Map([
  ...
  [PROPS_KEYS.textarea, { maxlength: 200, autosize: { minRows: 3, maxRows: 6 }, showCount: true, clearable: true }],
  [PROPS_KEYS['input-password'], { maxlength: 100, clearable: true }],
  [PROPS_KEYS['input-number'], { max: 10 ** 15 - 1, min: -(10 ** 15 + 1), controls: false, clearable: true }],
  ...
  [PROPS_KEYS['date-picker.week'], { clearable: true }],
