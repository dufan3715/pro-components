...
export const INIT_COMPONENT_PROPS_MAP = new Map([
  ...
  [PROPS_KEYS['date-picker'], { allowClear: true, placeholder: '请选择' }],
  [PROPS_KEYS['date-picker.week'], { allowClear: true, placeholder: '请选择' }],
  [PROPS_KEYS['date-picker.month'], { allowClear: true, placeholder: '请选择' }],
  [PROPS_KEYS['date-picker.year'], { allowClear: true, placeholder: '请选择' }],
  [PROPS_KEYS['date-picker.quarter'], { allowClear: true, placeholder: '请选择' }],
  [PROPS_KEYS['time-picker'], { allowClear: true, placeholder: '请选择' }],
